...
valid_data_file = 'msr-paraphrase-corpus/analogies_paraphrases_valid_20k.csv'
test_data_file = 'msr-paraphrase-corpus/analogies_paraphrases_test_20k.csv'
train_data_file = 'msr-paraphrase-corpus/analogies_paraphrases_train_400k.csv'
